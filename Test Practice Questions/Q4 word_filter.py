...
def word_filter_counter(text, filter_words):
    # Normalize the text and filter_words to lowercase
    text = text.lower()
    ...
    # Filter the words and count them
...
example_text = "Hello, this is a test. This test is just a sample. A simple sample."
example_filter_words = ["this", "test", "a", "sample"]
word_filter_counter(example_text, example_filter_words)
