...
inventory = {"Book":7,"Candle":10,"Wood":21,"Album":17,"Photo":56}
...
def manage_inventory():
    while True:
        ...
        if choice == "1":
            item = input("Please enter the item that you want to add:")
            quantity = int(input("please enter the quantity that is added:"))
        ...
        #    and then call the update_item function.
            ...
            item = input("Please enter the item that you want to change.")
            quantity = input("please enter the quantity that you want to change.")
